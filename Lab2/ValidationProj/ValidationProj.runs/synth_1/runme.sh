...
HD_PWD='D:/University/Semester_07/CS4363_Hardware_Description_Languages/Labs/Lab2/ValidationProj/ValidationProj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log what_for.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source what_for.tcl
