...
HD_PWD='D:/University/Semester_07/CS4363_Hardware_Description_Languages/Labs/Lab2/ValidationProj/ValidationProj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log what_for.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source what_for.tcl -notrace
